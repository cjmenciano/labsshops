...
$pdf->SetWidths(array(104.9,95,30,25,15));
            ...
            while($time_row=$time_query->fetch()){
                ...
                $sched_query = $db->query("SELECT * FROM phys_sched_tbl WHERE sched_day_id='4' AND sched_start='$time_start' ORDER BY sched_day_id ASC, sched_start ASC, sched_room_id ASC");
                        ...
                        $sched_count= $db->query("SELECT * FROM phys_sched_tbl WHERE sched_day_id = 4  AND sched_start='$time_start'");
...
$pdf->Output('I','Thursday-Laboratory Courses Master Schedule.pdf');
?>