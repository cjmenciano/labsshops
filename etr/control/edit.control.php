<?php
    ...
    if(isset($_POST['edit_educ_submit'])){
        ...
        /*$educ_query = "UPDATE etr_educator_tbl SET educ_fname='$educFirstname', educ_lname='$educLastname', educ_dept='$educDept' WHERE educ_id='$edit_educ_id'";
        $educ_result = pg_query($db_handle, $educ_query);*/

        $educ_query = "UPDATE etr_educator_tbl SET educ_fname=:educ_fname, educ_lname=:educ_lname, educ_dept=:educ_dept WHERE educ_id=:educ_id";
    ...
    if(isset($_POST['edit_course_submit'])){
        ...
        /*$course_query = "UPDATE etr_course_tbl SET course_code='$courseCode', course_desc='$courseDesc' WHERE course_id='$edit_course_id'";
        $course_result = pg_query($db_handle, $course_query);*/

        $course_query = "UPDATE etr_course_tbl SET course_code=:course_code, course_desc=:course_desc WHERE course_id=:course_id";
    ...
    if(isset($_POST['edit_room_submit'])){
        ...
        /*$room_query = "UPDATE etr_room_tbl SET room_num='$roomNum', room_name='$roomName', flr_area='$flrArea' WHERE room_id='$edit_room_id'";
        $room_result = pg_query($db_handle, $room_query);*/

        $room_query = "UPDATE etr_room_tbl SET room_num=:room_num, room_name=:room_name, flr_area=:flr_area WHERE room_id=:room_id";
    ...
    if(isset($_POST['edit_sched_submit'])){
        ...
        /*$sched_query = "UPDATE etr_sched_tbl 
