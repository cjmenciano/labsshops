<?php
    ...
    if(isset($_POST['educ_submit'])){
        ...
        /*$educ_query = "INSERT INTO etr_educator_tbl (educ_fname, educ_lname, educ_dept) VALUES ('$educFirstname','$educLastname','$educDept')";
        $educ_result = pg_query($db_handle, $educ_query);*/

        $educ_query = "INSERT INTO etr_educator_tbl (educ_fname, educ_lname, educ_dept) VALUES (:fname, :lname, :dept)";
    ...
    if(isset($_POST['course_submit'])){
        ...
        /*$course_query = "INSERT INTO etr_course_tbl (course_code, course_desc) VALUES ('$courseCode','$courseDesc')";
        $course_result = pg_query($db_handle, $course_query);*/

        $course_query = "INSERT INTO etr_course_tbl (course_code, course_desc) VALUES (:course, :course_desc)";
    ...
    if(isset($_POST['room_submit'])){
        ...
        /*$room_query = "INSERT INTO etr_room_tbl (room_num, room_name, flr_area) VALUES ('$roomNum','$roomName','$flrArea')";
        $room_result = pg_query($db_handle, $room_query);*/

        $room_query = "INSERT INTO etr_room_tbl (room_num, room_name, flr_area) VALUES (:room_num, :room_name, :flr_area)";
    ...
    if(isset($_POST['sched_submit'])){
        ...
        if($sched_day == 7){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (1,2) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 8){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (1,3) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 9){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (1,4) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 10){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (1,5) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 11){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (1,6) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 12){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (2,3) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 13){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (2,4) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 14){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (2,5) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 15){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (2,6) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 16){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (3,4) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 17){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (3,5) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 18){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (3,6) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 19){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (4,5) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 20){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (4,6) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 21){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (5,6) AND sched_room_id = '$sched_room'");
        }
        else if($sched_day == 22){
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id IN (1,3,5) AND sched_room_id = '$sched_room'");
        }
        else{
            $queryConflict= $db->query("SELECT * FROM etr_sched_tbl WHERE sched_day_id ='$sched_day' AND sched_room_id = '$sched_room'");
        }

       // echo $time_in.'-'.$time_out.'\n'.$sched_course_code.'\n'.$section.'\n'.$sched_educ.'\n'.$sched_room.'\n'.$sched_day;
        /*$sched_query = "INSERT INTO etr_sched_tbl (sched_start, sched_end, sched_day_id, sched_room_id, sched_educ_id, sched_course_id, sched_section) 
                ...
                ?>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-body">
                            <?php
                                /*$educ_query = "SELECT * from etr_educator_tbl WHERE educ_id='$sched_educ'";
                                $educ_result = pg_query($db_handle, $educ_query);
                                $educ_array = pg_fetch_array($educ_result);
                    
                                $course_query = "SELECT * from etr_course_tbl WHERE course_id='$sched_course_code'";
                                $course_result = pg_query($db_handle, $course_query);
                                $course_array = pg_fetch_array($course_result);
                    
                                $room_query = "SELECT * from etr_room_tbl WHERE room_id='$sched_room'";
                                $room_result = pg_query($db_handle, $room_query);
                                ...
                                $educ_query = $db->query("SELECT * from etr_educator_tbl WHERE educ_id='$conf_educ_id'");
                                $educ_array = $educ_query->fetch();
                
                                $course_query = $db->query("SELECT * from etr_course_tbl WHERE course_id='$conf_course_id'");
                                $course_array = $course_query->fetch();
                
                                $room_query = $db->query("SELECT * from etr_room_tbl WHERE room_id='$conf_room_id'");
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-body">
                        <?php
                            ...
                            $educ_query = $db->query("SELECT * from etr_educator_tbl WHERE educ_id='$sched_educ'");
                            $educ_array = $educ_query->fetch();
                
                            $course_query = $db->query("SELECT * from etr_course_tbl WHERE course_id='$sched_course_code'");                        
                            $course_array = $course_query->fetch();
                
                            $room_query = $db->query("SELECT * from etr_room_tbl WHERE room_id='$sched_room'");
                            $room_array = $room_query->fetch();
