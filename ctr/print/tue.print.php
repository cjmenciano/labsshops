...
$pdf->SetWidths(array(95,50,18.3,18.3,18.3,30,25,15));
            ...
            while($time_row=$time_query->fetch()){
                ...
                $sched_query = $db->query("SELECT * FROM ctr_sched_tbl WHERE sched_day_id='2' AND sched_start='$time_start' ORDER BY sched_day_id ASC, sched_start ASC, sched_room_id ASC");
                        ...
                        $sched_count= $db->query("SELECT * FROM ctr_sched_tbl WHERE sched_day_id = 2  AND sched_start='$time_start'");
