<?php
    ...
    if(isset($_POST['delete_educ_submit'])){
        ...
        $educ_query = "DELETE FROM ctr_educator_tbl WHERE educ_id='$delete_educ_id'";
        $educ_result = pg_query($db_handle, $educ_query);*/
        try{
        $educ_query = "DELETE FROM ctr_educator_tbl WHERE educ_id=:educ_id";
    ...
    <?php    
        ...
        $educ_query = $db->query("SELECT * from ctr_educator_tbl WHERE educ_id='$del_educ_id'");
    ...
    if(isset($_POST['delete_course_submit'])){
        ...
        $course_query = "DELETE FROM ctr_course_tbl WHERE course_id='$delete_course_id'";
        $course_result = pg_query($db_handle, $course_query);*/

        try{
        $course_query = "DELETE FROM ctr_course_tbl WHERE course_id=:course_id";
    ...
    <?php    
            ...
            $course_query = $db->query("SELECT * from ctr_course_tbl WHERE course_id='$del_course_id'");
    ...
    if(isset($_POST['delete_room_submit'])){
       ...
       // echo 'ID:'.$delete_room_id;
        ...
        $room_query = "DELETE FROM ctr_room_tbl WHERE room_id='$delete_room_id'";
        $room_result = pg_query($db_handle, $room_query);*/
        try{

        $room_query = "DELETE FROM ctr_room_tbl WHERE room_id=:room_id";
    ...
    <?php    
            ...
            $room_query = $db->query("SELECT * from ctr_room_tbl WHERE room_id='$del_room_id'");
    ...
    if(isset($_POST['delete_sched_submit'])){
        ...
        $sched_query = "DELETE FROM ctr_sched_tbl WHERE sched_id='$delete_sched_id'";
        $sched_result = pg_query($db_handle, $sched_query);*/

        $sched_query = "DELETE FROM ctr_sched_tbl WHERE sched_id=:sched_id";
