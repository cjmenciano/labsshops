    ...
    <div class="cd-schedule__events">
      <ul>
        <?php
            ...
            /*$room_query = 'SELECT * from ctr_room_tbl ORDER BY room_num';
            ...
            while($room_row=pg_fetch_assoc($room_result)){
              ...
              $sched_query = "SELECT * from ctr_sched_tbl WHERE sched_day_id='1' AND sched_room_id='$roomId'";
          ...
          $room_query = $db->query('SELECT * from ctr_room_tbl ORDER BY room_num');
          while($room_row=$room_query->fetch()){
            ...
            echo '<li class="cd-schedule__group">
                    ...
                    <ul>';
            $roomId = $room_row['room_id'];
            $sched_query = $db->query("SELECT * from ctr_sched_tbl WHERE sched_day_id='3' AND sched_room_id='$roomId'");
