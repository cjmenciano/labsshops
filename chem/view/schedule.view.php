    ...
    <tbody>
      <?php
        ...
        $page_no = $_GET['page_no'];
          ...
          /*$result_count = pg_query($db_handle, "SELECT COUNT(*) As total_records FROM chem_sched_tbl");
	        $total_records = pg_fetch_array($result_count);
	        $total_records = $total_records['total_records'];
          $total_no_of_pages = ceil($total_records / $total_records_per_page);
	        $second_last = $total_no_of_pages - 1; // total page minus 1*/

          $result_count = $db->query("SELECT COUNT(*) As total_records FROM chem_sched_tbl");
          $total_records = $result_count->fetch();
          $total_records = $total_records['total_records'];
          $total_no_of_pages = ceil($total_records / $total_records_per_page);
          $second_last = $total_no_of_pages - 1; // total page minus 1

          /*$sched_query = "SELECT * from chem_sched_tbl ORDER BY sched_day_id ASC,  sched_start ASC, sched_room_id ASC LIMIT $total_records_per_page OFFSET $offset";
          $sched_result = pg_query($db_handle, $sched_query);*/

          $sched_query = $db->query("SELECT * from chem_sched_tbl ORDER BY sched_day_id ASC,  sched_start ASC, sched_room_id ASC LIMIT $total_records_per_page OFFSET $offset");
      ...
      <div class="grid modal-body">
          ...
          <div class="form-floating mb-3">
              <select name="sched_course_code" id="sched_course_code" class="form-select form-select-lg">
                <?php 
                  $course_query = $db->query("SELECT * from chem_course_tbl ORDER BY course_code ASC");
                  //$course_result = pg_query($db_handle, $course_query);
          ...
          <div class="form-floating mb-3">
              <select name="sched_educ" id="sched_educ" class="form-select form-select-lg">
                <?php 
                  $educ_query = $db->query("SELECT * from chem_educator_tbl ORDER BY educ_lname ASC");
                  //$educ_result = pg_query($db_handle, $educ_query);
          ...
          <div class="form-floating mb-3">
              <select name="sched_room" id="sched_room" class="form-select form-select-lg">
                <?php 
                  $room_query = $db->query("SELECT * from chem_room_tbl ORDER BY room_num ASC");
                  //$room_result = pg_query($db_handle, $room_query);
